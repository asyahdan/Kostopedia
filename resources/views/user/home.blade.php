...
<body>
		...
		<div class="container">
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<a href="/home" class="logo m-0 float-start"><img src="https://raw.githubusercontent.com/asyahdan/Pemrograman-Web/main/simplelogo1.png" width="35" height="35">Kostopedia</a>

					<ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
						<li class="active"><a href="/">Beranda</a></li>
						<li class="active"></li>
						<li class="has-children">
							<a href="properties.html">Informasi</a>
							<ul class="dropdown">
								<li><a href="#">Kost</a></li>
								<li><a href="#">Kontrakan</a></li>
							</ul>
						</li>
						<li><a href="services.html">Daftar Properti</a></li>
			...
			<div class="row justify-content-center align-items-center">
				<div class="col-lg-9 text-center">
					...
					<form action="#" class="narrow-w form-search d-flex align-items-stretch mb-3" data-aos="fade-up" data-aos-delay="200">
						<input type="text" class="form-control px-4" placeholder="Masukan Alamat contoh : Arzimar, bangbarung">
	...
	<div class="section">
		<div class="container">
			<div class="row mb-5 align-items-center">
				<div class="col-lg-6">
					<h2 class="font-weight-bold text-primary heading">Properti populer</h2>
				</div>
	...
	<div class="site-footer">
		<div class="container">
            ...
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>. Octonity &mdash; Designed with love by <a href="https://untree.co">Untree.co</a> <!-- License information: https://untree.co/license/ -->
            </p>
